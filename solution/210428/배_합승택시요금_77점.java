...
class Solution {
    ...
    public static int dijkstra(int n, int s, int d, boolean start ){
        ...
        for(int a=0;a<n-1;a++){
            ...
            if(start) { 
            	startPoint[min_index]= min;
            }
            else if(!start && min_index == d) { 
            	return min;
            }
    ...
    public static int solution(int n, int s, int a, int b, int[][] fares) {
        ...
        for(int i=1; i<n+1; i++) {
           	...
           	ansList.add(startPoint[i]+dijkstra(n,i,a,false )+dijkstra(n,i,b,false ));
